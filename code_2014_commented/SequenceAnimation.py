...
#generation des dates de debut et de fin sous 2 formats differents
...
with writer.saving(fig,path_video, 400):
    for i in stade_files:
        ...
        #figure stades de developpement
        ...
        # Histogram stades de developpement
        ...
        if os.path.exists(path4):
            ...
            #MAX: Histogramme zones inondees
