...
def fetchLevel(whichDay = 'n'):
    ...
    #MAX: repechage des niveaux du lac d'hier et d'aujourdhui dans le code html de la page du groupe e.   
    ...
    #MAX: repechage des dates d'hier et d'aujourdhui dans le code html de la page du groupe e.
